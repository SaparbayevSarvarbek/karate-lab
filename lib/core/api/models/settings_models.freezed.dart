...
mixin _$AppSettings {
 ...
 int get id; String get language; Map<String, dynamic>? get notificationPreferences;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppSettings&&(identical(other.id, id) || other.id == id)&&(identical(other.language, language) || other.language == language)&&const DeepCollectionEquality().equals(other.notificationPreferences, notificationPreferences));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,language,const DeepCollectionEquality().hash(notificationPreferences));

@override
String toString() {
  return 'AppSettings(id: $id, language: $language, notificationPreferences: $notificationPreferences)';
}
...
@useResult
$Res call({
 int id, String language, Map<String, dynamic>? notificationPreferences
});
...
/// Create a copy of AppSettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? language = null,Object? notificationPreferences = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,language: null == language ? _self.language : language // ignore: cast_nullable_to_non_nullable
as String,notificationPreferences: freezed == notificationPreferences ? _self.notificationPreferences : notificationPreferences // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String language,  Map<String, dynamic>? notificationPreferences)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppSettings() when $default != null:
return $default(_that.id,_that.language,_that.notificationPreferences);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String language,  Map<String, dynamic>? notificationPreferences)  $default,) {final _that = this;
switch (_that) {
case _AppSettings():
return $default(_that.id,_that.language,_that.notificationPreferences);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String language,  Map<String, dynamic>? notificationPreferences)?  $default,) {final _that = this;
switch (_that) {
case _AppSettings() when $default != null:
return $default(_that.id,_that.language,_that.notificationPreferences);case _:
  return null;
...
class _AppSettings implements AppSettings {
  const _AppSettings({this.id = 0, this.language = 'uz', final  Map<String, dynamic>? notificationPreferences}): _notificationPreferences = notificationPreferences;
  factory _AppSettings.fromJson(Map<String, dynamic> json) => _$AppSettingsFromJson(json);

@override@JsonKey() final  int id;
@override@JsonKey() final  String language;
 final  Map<String, dynamic>? _notificationPreferences;
@override Map<String, dynamic>? get notificationPreferences {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppSettings&&(identical(other.id, id) || other.id == id)&&(identical(other.language, language) || other.language == language)&&const DeepCollectionEquality().equals(other._notificationPreferences, _notificationPreferences));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,language,const DeepCollectionEquality().hash(_notificationPreferences));
...
/// Create a copy of AppSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? language = null,Object? notificationPreferences = freezed,}) {
  return _then(_AppSettings(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,language: null == language ? _self.language : language // ignore: cast_nullable_to_non_nullable
as String,notificationPreferences: freezed == notificationPreferences ? _self._notificationPreferences : notificationPreferences // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,
  ));
}
...
mixin _$UserSession {
 ...
 int get id; String get deviceInfo; String? get ipAddress; bool get isActive; DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,deviceInfo,ipAddress,isActive,createdAt);

@override
String toString() {
  return 'UserSession(id: $id, deviceInfo: $deviceInfo, ipAddress: $ipAddress, isActive: $isActive, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 int id, String deviceInfo, String? ipAddress, bool isActive, DateTime? createdAt
});
...
/// Create a copy of UserSession
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? deviceInfo = null,Object? ipAddress = freezed,Object? isActive = null,Object? createdAt = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String deviceInfo,  String? ipAddress,  bool isActive,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserSession() when $default != null:
return $default(_that.id,_that.deviceInfo,_that.ipAddress,_that.isActive,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String deviceInfo,  String? ipAddress,  bool isActive,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _UserSession():
return $default(_that.id,_that.deviceInfo,_that.ipAddress,_that.isActive,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String deviceInfo,  String? ipAddress,  bool isActive,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _UserSession() when $default != null:
return $default(_that.id,_that.deviceInfo,_that.ipAddress,_that.isActive,_that.createdAt);case _:
  return null;
...
class _UserSession implements UserSession {
  const _UserSession({this.id = 0, this.deviceInfo = '', this.ipAddress, this.isActive = true, this.createdAt});
  factory _UserSession.fromJson(Map<String, dynamic> json) => _$UserSessionFromJson(json);

@override@JsonKey() final  int id;
@override@JsonKey() final  String deviceInfo;
...
/// Create a copy of UserSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? deviceInfo = null,Object? ipAddress = freezed,Object? isActive = null,Object? createdAt = freezed,}) {
